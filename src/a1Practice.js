export function renderA1Practice(container, appNavigate) {
  ...
  function renderGrammar() {
    let qHtml = \`<div class="quiz-question fade-in" style="text-align: left;">
      <h2 style="color: var(--text-main); margin-bottom: 1.5rem;">B. Điền từ vào chỗ trống (Ngữ pháp A1)</h2>
  ...
  function renderQuiz() {
    let qHtml = \`<div class="quiz-question fade-in" style="text-align: left;">
      <h2 style="color: var(--text-main); margin-bottom: 2rem;">A. Trắc nghiệm (20 câu)</h2>
    \`;
